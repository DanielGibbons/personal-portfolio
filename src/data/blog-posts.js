const BlogPosts = [
	{
		id: 'BP_2019_11_01_00',
		title: 'Generating a PFX SSL Certificate using GoDaddy',
		shortTitle: 'PFX SSL',
		date: '01/11/2019',
		last_modified: '01/11/2019',
		description: "A guide for generating a PFX SSL Certificate for an Azure App Service using certificates and keys provided by \
					  GoDaddy.",
		tags: ['Security', 'SSL']
	},
	{
